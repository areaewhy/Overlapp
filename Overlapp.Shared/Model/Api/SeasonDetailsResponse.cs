...
{
	public record SeasonDetailsResponse(string _id, string air_date, EpisodeWithCredits[] episodes, string name, string overview, int id, string poster_path, int season_number, float vote_average);
