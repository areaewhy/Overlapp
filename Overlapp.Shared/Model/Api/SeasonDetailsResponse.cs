...
{
	public record SeasonDetailsResponse(string _id, string air_date, Episode[] episodes, string name, string overview, int id, string poster_path, string season_number, string vote_average);
