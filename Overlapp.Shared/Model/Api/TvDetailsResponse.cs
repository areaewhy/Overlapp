namespace Overlapp.Shared.Model
{
	...
	public record Episode(int id, string name, string overview, float vote_average, int vote_count, string air_date, int episode_number, string production_code, int? runtime, int season_number, int show_id, string still_path, string episode_type = "standard");
